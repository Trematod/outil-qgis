PREPARATION DES DONNEES - VERSION PORTABLE WINDOWS

1. Decompressez le dossier dans un emplacement ou vous avez les droits d'ecriture.
2. Verifiez que le lecteur reseau S: est connecte.
